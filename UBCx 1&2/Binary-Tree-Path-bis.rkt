...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Binary-Tree-Path-bis) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (has-path? bt p)
  (cond [(false? bt) false]
        ...
        [else
         (if (and (node? bt)(string=? "L" (first p)))
