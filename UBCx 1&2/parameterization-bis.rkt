...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization-bis) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (map2 string-length (list "a" "bc" "def"))
              (list 1 2 3))
